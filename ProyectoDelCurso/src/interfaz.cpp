...
void mostrarBienvenida() {
    ...
    std::cout << "||      PROCESAMIENTO DE IMAGENES      ||\n";
    std::cout << "||                                     ||\n";
...
void ayuda() {
    ...
    std::cout << "||      - Muestra informacion de la imagen       ||\n";
    std::cout << "||        cargada.                               ||\n";
    std::cout << "||                                               ||\n";
    std::cout << "||   5. info_volumen                             ||\n";
    std::cout << "||      - Muestra informacion del volumen        ||\n";
    std::cout << "||        cargado.                               ||\n";
    std::cout << "||                                               ||\n";
    std::cout << "||   6. proyeccion2D <direccion> <criterio>      ||\n";
    std::cout << "||      <nombre_archivo.pgm>                     ||\n";
    std::cout << "||      - Genera una proyeccion 2D.              ||\n";
    std::cout << "||                                               ||\n";
